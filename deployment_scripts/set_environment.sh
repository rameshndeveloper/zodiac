...
export SIRMIONE_ALIAS=rnsirmione
export LIMONE_ALIAS=rnlimone
export SCORPIO_ALIAS=rnscorpio
export VIRGO_ALIAS=rnvirgo
export LIBRA_ALIAS=rnlibra
export ZODIAC_ALIAS=rnzodiac
export DB_ADMIN_USER=rameshn
